                                            ...
                                            @foreach ($allReview as $item)
                                                <tr>
                                                    ...
                                                    <td><a href="#"
                                                            ...
                                                            data-isi="{{ $item->review }}"
                                                            data-balasan="{{ $item->balasan ?? 'Belum ada balasan' }}">
                                            ...
                                            @foreach ($review as $r)
                                                <tr>
                                                    ...
                                                    <td><a href="#"
                                                            class="btn-detail bg-teal-600 hover:bg-teal-900 duration-200 text-white rounded text-base px-2 py-2"
                                                            data-toggle="modal" data-target="#detailUlasanModal"
                                                            data-nama="{{ $r->user->name ?? '-' }}"
                                                            data-tanggal="{{ date('d F Y', strtotime($r->created_at)) }}"
                                                            data-rating="{{ $r->rating }}"
                                                            {{-- data-review="{{ $r->review }}" --}}
                                                            data-isi="{{ $r->review }}"
                                                            data-balasan="{{ $r->balasan ?? 'Belum ada balasan' }}">
                                                            <i class="fa-solid fa-circle-info"></i>
                                                        </a>
                                                    </td>
                                                </tr>
