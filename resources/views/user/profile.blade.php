                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="user_code" class="form-control" id="user_code"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('profile.password.update') }}" method="POST">
                                ...
                                <button class="bg-yellow-600 hover:bg-yellow-900 duration-200 text-white rounded text-base px-2 py-2" type="submit">Ubah Kata Sandi</button>
                            </form>
                        </div>
                    </div>
                </div>
